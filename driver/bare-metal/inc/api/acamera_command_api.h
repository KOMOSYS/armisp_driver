...
#define CALIBRATION_CA_FILTER_MEM                         0x0000002B
#define CALIBRATION_CA_CORRECTION                         0x0000002C
#define CALIBRATION_CA_CORRECTION_MEM                     0x0000002D
#define CALIBRATION_LUT3D_MEM                             0x0000002E
#define CALIBRATION_DECOMPANDER0_MEM                      0x0000002F
#define CALIBRATION_DECOMPANDER1_MEM                      0x00000030
#define CALIBRATION_SHADING_RADIAL_R                      0x00000031
#define CALIBRATION_SHADING_RADIAL_G                      0x00000032
#define CALIBRATION_SHADING_RADIAL_B                      0x00000033
#define CALIBRATION_SHADING_RADIAL_IR                     0x00000034
#define CALIBRATION_SHADING_RADIAL_CENTRE_AND_MULT        0x00000035
#define CALIBRATION_AWB_MIX_LIGHT_PARAMETERS              0x00000036
#define CALIBRATION_SCALER_H_FILTER                       0x00000037
#define CALIBRATION_SCALER_V_FILTER                       0x00000038


// ------------------------------------------------------------------------------ //
//		DYNAMIC CALIBRATION VALUES
// ------------------------------------------------------------------------------ //
#define CALIBRATION_STITCHING_LM_MED_NOISE_INTENSITY      0x00000039
#define CALIBRATION_AWB_COLOUR_PREFERENCE                 0x0000003A
...
#define CALIBRATION_CMOS_EXPOSURE_PARTITION_LUTS          0x00000042
#define CALIBRATION_STATUS_INFO                           0x00000043
#define CALIBRATION_AUTO_LEVEL_CONTROL                    0x00000044
#define CALIBRATION_DP_SLOPE                              0x00000045
#define CALIBRATION_DP_THRESHOLD                          0x00000046
#define CALIBRATION_STITCHING_LM_MOV_MULT                 0x00000047
#define CALIBRATION_STITCHING_LM_NP                       0x00000048
#define CALIBRATION_STITCHING_MS_MOV_MULT                 0x00000049
#define CALIBRATION_STITCHING_MS_NP                       0x0000004A
#define CALIBRATION_STITCHING_SVS_MOV_MULT                0x0000004B
#define CALIBRATION_STITCHING_SVS_NP                      0x0000004C
#define CALIBRATION_EVTOLUX_PROBABILITY_ENABLE            0x0000004D
#define CALIBRATION_AWB_AVG_COEF                          0x0000004E
#define CALIBRATION_IRIDIX_AVG_COEF                       0x0000004F
#define CALIBRATION_IRIDIX_STRENGTH_MAXIMUM               0x00000050
#define CALIBRATION_IRIDIX_MIN_MAX_STR                    0x00000051
#define CALIBRATION_IRIDIX_EV_LIM_FULL_STR                0x00000052
#define CALIBRATION_IRIDIX_EV_LIM_NO_STR                  0x00000053
#define CALIBRATION_AE_CORRECTION                         0x00000054
#define CALIBRATION_AE_EXPOSURE_CORRECTION                0x00000055
#define CALIBRATION_SINTER_STRENGTH                       0x00000056
#define CALIBRATION_SINTER_STRENGTH1                      0x00000057
#define CALIBRATION_SINTER_THRESH1                        0x00000058
#define CALIBRATION_SINTER_THRESH4                        0x00000059
#define CALIBRATION_SINTER_INTCONFIG                      0x0000005A
#define CALIBRATION_SHARP_ALT_D                           0x0000005B
#define CALIBRATION_SHARP_ALT_UD                          0x0000005C
#define CALIBRATION_SHARP_ALT_DU                          0x0000005D
#define CALIBRATION_DEMOSAIC_UU_SLOPE                     0x0000005E
#define CALIBRATION_MESH_SHADING_STRENGTH                 0x0000005F
#define CALIBRATION_SATURATION_STRENGTH                   0x00000060
#define CALIBRATION_CCM_ONE_GAIN_THRESHOLD                0x00000061
#define CALIBRATION_RGB2YUV_CONVERSION                    0x00000062
#define CALIBRATION_AWB_ZONE_WGHT_HOR                     0x00000063
#define CALIBRATION_AWB_ZONE_WGHT_VER                     0x00000064
#define CALIBRATION_SHARPEN_FR                            0x00000065
#define CALIBRATION_SHARPEN_DS1                           0x00000066
#define CALIBRATION_TEMPER_STRENGTH                       0x00000067
#define CALIBRATION_SINTER_STRENGTH_MC_CONTRAST           0x00000068
#define CALIBRATION_EXPOSURE_RATIO_ADJUSTMENT             0x00000069
#define CALIBRATION_CNR_UV_DELTA12_SLOPE                  0x0000006A
#define CALIBRATION_FS_MC_OFF                             0x0000006B
#define CALIBRATION_SINTER_SAD                            0x0000006C
#define CALIBRATION_AF_LMS                                0x0000006D
#define CALIBRATION_AF_ZONE_WGHT_HOR                      0x0000006E
#define CALIBRATION_AF_ZONE_WGHT_VER                      0x0000006F
#define CALIBRATION_AE_CONTROL_HDR_TARGET                 0x00000070
#define CALIBRATION_AE_CONTROL                            0x00000071
#define CALIBRATION_CUSTOM_SETTINGS_CONTEXT               0x00000072
#define CALIBRATION_GAMMA_EV1                             0x00000073
#define CALIBRATION_GAMMA_EV2                             0x00000074
#define CALIBRATION_GAMMA_THRESHOLD                       0x00000075
...
#define CALIBRATION_TOTAL_SIZE 118
//------------------FILE TRANSFER-------------------
...
#define AF_STATE_ID                                       0x00000068
#define AF_ROI_ID                                         0x00000069
#define AF_MANUAL_CONTROL_ID                              0x0000006A
#define AE_MODE_ID                                        0x0000006B
#define AE_STATE_ID                                       0x0000006C
#define AE_SPLIT_PRESET_ID                                0x0000006D
#define AE_GAIN_ID                                        0x0000006E
#define AE_EXPOSURE_ID                                    0x0000006F
#define AE_ROI_ID                                         0x00000070
#define AE_COMPENSATION_ID                                0x00000071
#define AWB_MODE_ID                                       0x00000072
#define AWB_STATE_ID                                      0x00000073
#define AWB_TEMPERATURE_ID                                0x00000074
#define NOISE_REDUCTION_MODE_ID                           0x00000075
#define COLOR_MODE_ID                                     0x00000076
#define BRIGHTNESS_STRENGTH_ID                            0x00000077
#define CONTRAST_STRENGTH_ID                              0x00000078
#define SATURATION_STRENGTH_ID                            0x00000079
#define SHARPENING_STRENGTH_ID                            0x0000007A
#define SHADING_STRENGTH_ID                               0x0000007B
#define HUE_THETA_ID                                      0x0000007C
#define REGISTERS_ADDRESS_ID                              0x0000007D
#define REGISTERS_SIZE_ID                                 0x0000007E
#define REGISTERS_SOURCE_ID                               0x0000007F
#define REGISTERS_VALUE_ID                                0x00000080
