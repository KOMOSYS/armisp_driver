...
static long soc_lens_ioctl( struct v4l2_subdev *sd, unsigned int cmd, void *arg )
{
    ...
    case SOC_LENS_GET_NEXT_POS:
        ...
        break;
    case SOC_LENS_INFO_MINFOCUS_DISTANCE:
        ARGS_TO_PTR( arg )
            ->args.general.val_out = params->minfocus_distance;
        break;
    case SOC_LENS_INFO_HYPERFOCAL_DISTANCE:
        ARGS_TO_PTR( arg )
            ->args.general.val_out = params->hyperfocal_distance;
        break;
    case SOC_LENS_INFO_FOCAL_LENGTH:
        ARGS_TO_PTR( arg )
            ->args.general.val_out = params->focal_length;
        break;
    case SOC_LENS_INFO_APERTURE:
        ARGS_TO_PTR( arg )
            ->args.general.val_out = params->aperture;
        break;
    default:
