...
static long camera_ioctl( struct v4l2_subdev *sd, unsigned int cmd, void *arg )
{
    ...
    case SOC_SENSOR_INFO_PHYSICAL_WIDTH:
        ARGS_TO_PTR( arg )
            ->args.general.val_out = params->physical_width;
        break;
    case SOC_SENSOR_INFO_PHYSICAL_HEIGHT:
        ARGS_TO_PTR( arg )
            ->args.general.val_out = params->physical_height;
        break;
    default:
