...
static int isp_v4l2_ctrl_s_ctrl_custom( struct v4l2_ctrl *ctrl )
{
    ...
    case ISP_V4L2_CID_AF_REFOCUS:
        ...
        break;
    case ISP_V4L2_CID_AF_MODE_ID:
        LOG( LOG_INFO, "new af_mode_id: %d.\n", ctrl->val );
        ret = fw_intf_set_af_mode_id( ctx_id, ctrl->val );
        break;
    case ISP_V4L2_CID_AF_MANUAL_CONTROL_ID:
        LOG( LOG_INFO, "new af_manual_control: %d.\n", ctrl->val );
        ret = fw_intf_set_af_manual_control( ctx_id, ctrl->val );
        break;
    case ISP_V4L2_CID_AWB_MODE_ID:
...
static const struct v4l2_ctrl_config isp_v4l2_ctrl_ae_state_id = {
    .ops = &isp_v4l2_ctrl_ops_custom,
...
static const struct v4l2_ctrl_config isp_v4l2_ctrl_awb_state_id = {
    .ops = &isp_v4l2_ctrl_ops_custom,
...
int isp_v4l2_ctrl_init( uint32_t ctx_id, isp_v4l2_ctrl_t *ctrl )
{
    ...
    ADD_CTRL_CST_VOLATILE( ISP_V4L2_CID_AE_STATE_ID, &isp_v4l2_ctrl_ae_state_id, NULL );
    ADD_CTRL_CST_VOLATILE( ISP_V4L2_CID_AWB_STATE_ID, &isp_v4l2_ctrl_awb_state_id, NULL );
