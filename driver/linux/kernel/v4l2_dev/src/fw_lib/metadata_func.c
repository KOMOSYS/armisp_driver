...
#if ISP_HAS_COLOR_MATRIX_FSM
    fsm_param_lsc_mesh_map_t lsc_mesh_map;
    lsc_mesh_map.width = 0;
    lsc_mesh_map.height = 0;
    lsc_mesh_map.map = &md->lsc_map;
    acamera_fsm_mgr_get_param( p_fsm->cmn.p_fsm_mgr, FSM_PARAM_GET_SHADING_MESH_MAP,
                               NULL, 0, &lsc_mesh_map, sizeof( lsc_mesh_map ) );
    md->lsc_map_width = lsc_mesh_map.width;
    md->lsc_map_height = lsc_mesh_map.height;
#endif
}
